...
export default function Login() {
  ...
  return (
    <div className=" bg-gray-100 py-6 flex flex-col justify-center sm:py- pt-[10vh]">
            ...
            <div className="divide-y divide-gray-200">
              <div className="pt-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="pt-4 flex flex-col items-center gap-2">
                  <button
                    onClick={() => actionForm()}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline text-sm"
                  >
                    Se connecter
                  </button>
                  <NavLink
