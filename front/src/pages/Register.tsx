...
export default function Register() {
  ...
  const labelClassName = "absolute left-1 -top-5 text-gray-600 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 text-[12px] peer-focus:text-[12px] peer-placeholder-shown:text-sm";
                ...
                {steps[currentStepIndex]?.label === Labels.Step1 ? (
                  <div>
                    <div className="flex gap-4">
                      <FormInput id="lastName" label="Nom" value={lastName} setValue={setLastName} isOptional={true}></FormInput>
                      <FormInput id="firstName" label="Prénom" value={firstName} setValue={setFirstName} isOptional={true}></FormInput>
                    </div>
                    <div className="flex gap-4">
                      <FormInput id="email" type="email" label="Email" value={email} setValue={setEmail} isOptional={true}></FormInput>
                    </div>
                    <div className="flex gap-4">
                      <FormInput id="password1" type="password" label="Mot de passe" value={password1} setValue={setPassword1} isOptional={true}></FormInput>
                      <FormInput id="password2" type="password" label="Répétition du mot de passe" value={password2} setValue={setPassword2} isOptional={true}></FormInput>
                      
                    </div>
                    <div>
                      <PasswordStrengthBar password={password1} scoreWords={['Très faible', 'Faible', 'Moyen', 'Fort', 'Très fort']} shortScoreWord={'Trop court '}/>
                    </div>
                    <div className="flex gap-4">
                      <FormInput id="phoneNumber" type="tel" label="Numéro de téléphone" value={phoneNumber} setValue={setPhoneNumber} isOptional={true}></FormInput>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {role === Roles.HEALTH_ACTOR ? (
                      ...
                      <div>
                        <FormInput id="companyName" label="Nom de votre entreprise " value={companyName} setValue={setCompanyName}></FormInput>
