      ...
      <div className="flex justify-end items-center bg-gray-200 h-8">
        {isAuthenticated() ? (
          <div className="flex gap-2 text-[16px] pr-8">
            ...
            <div className="cursor-pointer">Bonjour {localStorage.getItem('userFirstname')} {localStorage.getItem('userLastname')} </div>
            <span>|</span>
            ...
            >            
              <li className="mx-1 w-full">
                <NavLink
                  to="/professionnels/sante"
                  className={({ isActive }) =>
                    isActive ? "bg-primary text-white w-full" : "w-full hover:bg-primary-hover"
                  }
                >
                  Santé
                </NavLink>
